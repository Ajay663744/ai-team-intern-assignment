...
## A1 — Build multilingual evaluation corpus
**Date:** 2026-09-06
...
## A2 — Audit of the original fertility benchmark
...
python partA\A3\analysis_a3.py `
...
The notebook is ordered chronologically by the completed work: A1 corpus construction → A2 script audit → A3 corrected tokenizer analysis → A4 recommendation memo → B1–B4 capacity reconciliation. The A2 regression tests and the B3 ITL discrepancy are retained because they document validation results and a dead-end/check that changed the interpretation.
